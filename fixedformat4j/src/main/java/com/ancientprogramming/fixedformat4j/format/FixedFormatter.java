 ...
 * <p/>
 * Example: <p><code>@Field(offset = 1, length = 20, formatter = {@link
 * DateFormatter}.class)</code></p>
 *
...
public interface FixedFormatter<T> {
  ...
  /**
   * Parses the given String value according to the format instruction. How the data is parsed and
   * to what object is defined by the implementor.
   *
   ...
   * @return a string representation of the value object after it was formatted according to the
   * instructions
